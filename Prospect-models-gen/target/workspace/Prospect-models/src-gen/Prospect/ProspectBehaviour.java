...
public class ProspectBehaviour {
	private ResourceLocatorProvider locatorProvider;

    public static void main(String[] args) {
        ProspectBehaviour behaviour = new ProspectBehaviour();
    ...
    public ResourceState getRIM() {
        ...
        initial = factory.getResourceState("Prospect.Prospect.ServiceDocument");
        return initial;
    }
    ...
    public ResourceState getExceptionResource() {
        ...
        exceptionState = factory.getResourceState("Prospect.Prospect.InteractionException");
